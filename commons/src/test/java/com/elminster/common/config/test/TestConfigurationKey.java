...
public class TestConfigurationKey {
  ...
  public void testConfigurationKey() {
    ...
    Assert.assertEquals(new Integer(1), config.getIntegerProperty(ik1));
    Assert.assertEquals(new Integer(2), config.getIntegerProperty(ik2));
    ...
    Assert.assertEquals(new Long(1), config.getLongProperty(lk1));
    Assert.assertEquals(new Long(2), config.getLongProperty(lk2));
    ...
    Assert.assertEquals(new Float(1.0f), config.getFloatProperty(fk1));
    Assert.assertEquals(new Float(2.0f), config.getFloatProperty(fk2));
    ...
    Assert.assertEquals(new Double(1.0), config.getDoubleProperty(dk1));
    Assert.assertEquals(new Double(2.0), config.getDoubleProperty(dk2));
