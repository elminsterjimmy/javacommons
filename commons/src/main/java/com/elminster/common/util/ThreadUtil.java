...
abstract public class ThreadUtil {
   ...
   * {@code null} is returned if no such thread exists
   * @throws IllegalArgumentException
   *     if the specified id is zero or negative or the group name is null
   * @throws SecurityException
   *     if the current thread cannot access the system thread group
   * @throws SecurityException
   *     if the current thread cannot modify
   ...
   *     the thread group
   * @param recurse
   *     if {@code true} then evaluate the predicate recursively on all threads in all subgroups of the given group
   * @param predicate
   *     the predicate
   ...
   *     the thread group
   * @param recurse
   *     if {@code true} then evaluate the predicate recursively on all threadgroups in all subgroups of the given group
   * @param predicate
   *     the predicate
