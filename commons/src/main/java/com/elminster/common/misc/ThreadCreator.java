 ...
 * @version 1.0
 */
final public class ThreadCreator {
   ...
   * <p>
   * The default implementation creates a new Thread for the given {@link Runnable}, applying an appropriate thread
   * name.
   * 
   * @param runnable
   ...
   * <p>
   * The default implementation returns the specified thread name prefix with an increasing thread count appended: e.g.
